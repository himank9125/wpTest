...
function App() {
  ...
  function changeSelectedState(e) {
  ...
  function changeSelectedCity(e) {
    setSelectedCity(e.target.value);

    setSelectedLandMark(0);
  }

  function changeSelectedLandmark(e) {
  ...
  return (
    <div id="main">
      <select id="state" onChange={changeSelectedState} value={selectedState}>
      ...
      <select id="city" onChange={changeSelectedCity} value={selectedCity}>
      ...
      <select
        id="landmark"
        onChange={changeSelectedLandmark}
